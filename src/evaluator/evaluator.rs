...
pub fn evaluate(program: Program) -> Result<Rc<Object>, EvalError> {
...
fn evaluate_statement(statment: &Statement) -> Result<Rc<Object>, EvalError> {
    match statment {
        Statement::Expression(expression_statemnt) => evaluate_expression(&expression_statemnt.expression),
...
fn evaluate_string_infix(left: &String, operator: InfixOperator, right: &String) -> Result<Rc<Object>, String> {
    match operator {
